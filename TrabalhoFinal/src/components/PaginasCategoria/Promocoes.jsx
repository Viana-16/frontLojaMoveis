...
//           (p) => p.categoria.toLowerCase() === "promocoes"
//         );

//         console.log("Produtos filtrados pela categoria 'promocoes':", produtosFiltrados);
