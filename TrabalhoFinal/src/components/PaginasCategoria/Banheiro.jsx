...
//           (p) => p.categoria.toLowerCase() === "banheiro"
//         );

//         console.log("Produtos filtrados pela categoria 'banheiro':", produtosFiltrados);
